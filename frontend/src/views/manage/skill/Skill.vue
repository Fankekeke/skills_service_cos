...
import BulletinAdd from './SkillAdd.vue'
import BulletinEdit from './SkillEdit.vue'
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/staff-skill/' + ids).then(() => {
