<template>
  <a-modal v-model="show" title="修改技能服务" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        ...
        <a-col :span="12">
          <a-form-item label='技能服务类型' v-bind="formItemLayout">
            <a-select v-decorator="[
              'type',
              { rules: [{ required: true, message: '请输入技能服务类型!' }] }
              ]">
              <a-select-option value="1">系统技能服务</a-select-option>
        ...
        <a-col :span="12">
          <a-form-item label='技能服务状态' v-bind="formItemLayout">
            <a-select v-decorator="[
              'rackUp',
              { rules: [{ required: true, message: '请输入技能服务状态!' }] }
              ]">
        ...
        <a-col :span="24">
          <a-form-item label='技能服务内容' v-bind="formItemLayout">
