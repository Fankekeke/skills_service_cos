              ...
              <div style="font-size: 12px;font-family: SimHei;color: #404040;margin-top: 15px">
                ...
                <a-row style="padding-left: 24px;padding-right: 24px;">
                  <a-col style="margin-bottom: 15px"><span
                    style="font-size: 15px;font-weight: 650;color: #000c17">需求描述</span></a-col>
                  <a-col :span="24">
                ...
                <a-row style="padding-left: 24px;padding-right: 24px;">
                  <a-col style="margin-bottom: 15px"><span
                    style="font-size: 15px;font-weight: 650;color: #000c17">需求图册</span></a-col>
                  <a-col :span="24">
                    <a-upload
                      name="avatar"
                ...
                <div style="font-size: 13px;font-family: SimHei" v-if="startAddressInfo !== null">
                  <a-row style="padding-left: 24px;padding-right: 24px;">
                    <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">需求地址</span>
                    </a-col>
                ...
                <div style="font-size: 13px;font-family: SimHei" v-if="staffInfo !== null">
                  <a-row style="padding-left: 24px;padding-right: 24px;">
                    <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">服务人员信息</span>
                    </a-col>
