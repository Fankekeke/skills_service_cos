<template>
  <a-modal v-model="show" title="新增服务人员" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='服务人员姓名' v-bind="formItemLayout">
            <a-input v-decorator="[
            'name',
        ...
        <a-col :span="12">
          <a-form-item label='服务人员性别' v-bind="formItemLayout">
            <a-select v-decorator="[
              'sex',
              { rules: [{ required: true, message: '请输入服务人员性别!' }] }
              ]">
